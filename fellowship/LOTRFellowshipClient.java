...
public class LOTRFellowshipClient extends ROMEFellowShip {
	public UUID fellowshipID;
	public String fellowshipName;
	public ItemStack fellowshipIcon;
	public boolean isOwned;

	public GuildInventory inventory = new GuildInventory(this);
	...
	public ArrayList<QuestBase> getQuests() { return quests; }

	public byte[] getQuestData() { return questData; }
	...
	public void setFaction(String f) {faction = f; }
	...
	public void setLastQuestDate(String d) {lastQuestDate = d;}

	public void setQuestData(byte[] s) {questData = s;}


	public void setLevel(int i) {level = i;}

	public void setIsUpgraded(boolean isUpgr) { this.isUpgraded = isUpgr; }
	...
	public void updateDataFrom(LOTRFellowshipClient other) {
		...
		xp = other.xp;
		quests = other.quests;
		questData = other.questData;
		lastQuestDate = other.lastQuestDate;
		color = other.color;
	}
